...
The goal of regexcite.sandy is to is to make regular expressions more exciting!
...
You can install the development version of regexcite.sandy from [GitHub](https://github.com/) with:
